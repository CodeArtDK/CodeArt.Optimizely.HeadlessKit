...
{
    [DisplayTemplate(Key = "ImageElementDefault", DisplayName = "Image Element",
        ContentType = "ImageElement", IsDefault = true)]
    public class ImageElementDisplayTemplate : SaaSDisplayTemplate
    {
        [JsonIgnore]
